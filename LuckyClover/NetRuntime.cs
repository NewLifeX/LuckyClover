...
public class NetRuntime
{
    ...
    public const String Version8 = "8.0.17";
    public const String Version9 = "9.0.6";
    #endregion
    ...
    public void AutoInstallNet()
    {
        ...
        else if (osVer.Major == 6 && osVer.Minor == 1)
        {
            ...
            {
                InstallNet48();
                InstallNet("v6.0", Version6);
            }
        }
        // Win10/Win11
        else if (osVer.Major >= 10)
        {
            InstallNet("v9.0", Version9, "desktop");
        }
        else
        {
            InstallNet48();
            InstallNet("v8.0", Version8, "desktop");
        }
    }
    #endregion
